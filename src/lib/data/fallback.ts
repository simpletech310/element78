...
export const fallbackTrainers: Trainer[] = [
  ...
  { id: "tr-simone", slug: "simone-okafor", name: "Simone Okafor", headline: "Mobility + recovery. Yoga + breathwork.", bio: "Restoration as resistance.", specialties: ["Yoga","Breathwork","Mobility"], avatar_url: "/assets/IMG_3467.jpg", hero_image: "/assets/IMG_3467.jpg", home_location_id: "loc-atl", rating: 4.97 },
  { id: "tr-nova", slug: "nova-thomas", name: "Nova Thomas", headline: "Reformer + barre. 5 yrs.", bio: "Long lines, slow burns. Music loud, breath quiet.", specialties: ["Reformer","Barre","Pilates"], avatar_url: "/assets/IMG_3465.jpg", hero_image: "/assets/IMG_3465.jpg", home_location_id: "loc-atl", rating: 4.93 },
...
export const fallbackClasses: ClassRow[] = [
  ...
  { id: "cls-2", slug: "core-78-1", location_id: "loc-atl", trainer_id: "tr-simone", name: "CORE 78", kind: "pilates", starts_at: at(0, 7, 0), duration_min: 45, capacity: 12, booked: 8, intensity: "HI", room: "STUDIO A", hero_image: "/assets/floor-mockup.png" },
  { id: "cls-3", slug: "morning-mobility", location_id: "loc-atl", trainer_id: "tr-simone", name: "MORNING MOBILITY", kind: "yoga", starts_at: at(0, 6, 0), duration_min: 30, capacity: 16, booked: 4, intensity: "LO", room: "STUDIO C", hero_image: "/assets/IMG_3467.jpg" },
...
export const fallbackPosts: Post[] = [
  ...
  { id: "ps3", author_id: null, kind: "milestone", body: "PR · Reformer footwork to plank. Held it.", media_url: "/assets/IMG_3467.jpg", meta: { author: "NOVA T.", pr: "Plank · 2:30" }, created_at: new Date(Date.now() - 1000*60*60*4).toISOString() },
